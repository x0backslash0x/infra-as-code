...
# Labo 9
bestanden aanmaken
* esxi-pass (esxi wachtwoord)
* local-pas (esxi gebruiker wachtwoord)
...
* [community-vmware.vmware_guest_powerstate](https://docs.ansible.com/ansible/latest/collections/community/vmware/vmware_guest_powerstate_module.html#ansible-collections-community-vmware-vmware-guest-powerstate-module)
